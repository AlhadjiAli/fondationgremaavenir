        ...
        <div className="mx-auto max-w-2xl py-40 px-4s sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="bg-image-what">
                ...
                <div className="lg:relative">
                    <Image src={'/assets/clientsay/image-3.jpg'} alt="avatar-image" width={1061} height={733} className="hidden lg:block" style={{ border: '15px solid white', borderRadius: '150px' }} />

                    <span className="lg:absolute lg:bottom-40 lg:left-80" >
                        <Image src={'/assets/clientsay/2ag.png'} alt="user-image" width={168} height={168} className="mx-auto pt-10 lg:pb-10" style={{ borderRadius: '50%' }} />
                        <div className="lg:inline-block bg-white rounded-2xl p-5 shadow-sm">
                            ...
                            <h3 className="text-2xl font-medium text-center py-2">Alhadji Ali G.</h3>
                            <h4 className="text-sm font-normal text-center"> Softward Developer</h4>
                        </div>
                    </span>
